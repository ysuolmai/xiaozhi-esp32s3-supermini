...
def update_kconfig(filepath):
    ...
    # Check if already added
    if 'BOARD_TYPE_ESP32S3_SUPERMINI' in content:
        print('Kconfig.projbuild already contains ESP32S3_SUPERMINI, skipping')
        return
    
    new_option = '''    config BOARD_TYPE_ESP32S3_SUPERMINI
        bool "ESP32-S3 SuperMini (4MB Flash / 2MB PSRAM, MAX98357A + INMP441 + ST7789)"
